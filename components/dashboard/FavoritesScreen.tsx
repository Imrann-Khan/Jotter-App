...
const FileItem: React.FC<FileItemProps> = ({
  ...
  const handleMenuPress = () => {
    // Position for context menu based on screen width and item position
    onMenuPress({ x: 300, y: 125 });
  };
...
export const FavoritesScreen: React.FC<FavoritesScreenProps> = ({
  ...
  const favoriteItems = [
    { type: "image", name: "image.123", date: "Jan 18, 2025" },
    { type: "image", name: "image.123", date: "Jan 18, 2025" },
    { type: "image", name: "image.123", date: "Jan 18, 2025" },
    { type: "folder", name: "Folder.1", date: "Jan 18, 2025" },
    { type: "image", name: "image.123", date: "Jan 18, 2025" },
    { type: "link", name: "link .1", date: "Jan 18, 2025" },
    { type: "pdf", name: "docoment.1", date: "Jan 18, 2025" },
    { type: "image", name: "image.123", date: "Jan 18, 2025" },
    { type: "image", name: "image.123", date: "Jan 18, 2025" },
  ];
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#FFFFFF" }}>
          ...
          {favoriteItems.map((item, index) => (
            <FileItem
              ...
              onMenuPress={(position) =>
                handleFileMenuPress(item.name, position)
              }
            />
          ))}
        </View>
      ...
      {/* Bottom Navigation */}
      <BottomNavigation activeTab="bookmark" onTabPress={onTabPress} />
