...
const BatteryIcon: React.FC = () => (
  <Svg width="25" height="13" viewBox="0 0 25 13" fill="none">
    ...
    />
    <Path
      d="M23.4772 4.80762V8.86564C24.2882 8.52195 24.8155 7.72243 24.8155 6.83663C24.8155 5.95083 24.2882 5.15131 23.4772 4.80762Z"
      fill="#181818"
    />
  </Svg>
);
...
const MobileSignalIcon: React.FC = () => (
  <Svg width="18" height="12" viewBox="0 0 18 12" fill="none">
    <Path
      d="M9.77094 3C9.77094 2.44772 10.197 2 10.7226 2H11.6744C12.2 2 12.6261 2.44772 12.6261 3V11C12.6261 11.5523 12.2 12 11.6744 12H10.7226C10.197 12 9.77094 11.5523 9.77094 11V3Z"
      fill="#181818"
    />
    <Path
      d="M14.5295 1C14.5295 0.447715 14.9556 0 15.4812 0H16.4329C16.9585 0 17.3846 0.447715 17.3846 1V11C17.3846 11.5523 16.9585 12 16.4329 12H15.4812C14.9556 12 14.5295 11.5523 14.5295 11V1Z"
      fill="#181818"
    />
    <Path
      d="M5.01239 6.5C5.01239 5.94772 5.43849 5.5 5.9641 5.5H6.91581C7.44143 5.5 7.86752 5.94772 7.86752 6.5V11C7.86752 11.5523 7.44143 12 6.91581 12H5.9641C5.43849 12 5.01239 11.5523 5.01239 11V6.5Z"
      fill="#181818"
    />
    <Path
      d="M0.253845 9C0.253845 8.44772 0.67994 8 1.20555 8H2.15726C2.68288 8 3.10897 8.44772 3.10897 9V11C3.10897 11.5523 2.68288 12 2.15726 12H1.20555C0.67994 12 0.253845 11.5523 0.253845 11V9Z"
      fill="#181818"
    />
  </Svg>
);
