...
import { ImageIcon, BackIcon, SearchIcon } from "../components/ui/FileIcons";
...
export const ImagesScreen: React.FC<ImagesScreenProps> = ({ onBackPress }) => {
  const [searchQuery, setSearchQuery] = useState("");

  const images = [
    { id: 1, name: "image.123", date: "Jan 18, 2025" },
    { id: 2, name: "image.123", date: "Jan 18, 2025" },
    { id: 3, name: "image.123", date: "Jan 18, 2025" },
    { id: 4, name: "image.123", date: "Jan 18, 2025" },
    { id: 5, name: "image.123", date: "Jan 18, 2025" },
    { id: 6, name: "image.123", date: "Jan 18, 2025" },
    { id: 7, name: "image.123", date: "Jan 18, 2025" },
  ];
      ...
      >
        {images.map((image) => (
          <ItemListRow
            ...
            title={image.name}
            date={image.date}
            onPress={() => console.log(`Image ${image.name} pressed`)}
            onMenuPress={() => console.log(`Menu for ${image.name} pressed`)}
          />
        ))}
      </ScrollView>
