...
import { FolderIcon, BackIcon, SearchIcon } from "../components/ui/FileIcons";
...
export const FoldersScreen: React.FC<FoldersScreenProps> = ({
  ...
  const folders = [
    { id: 1, name: "Folder.1", date: "Jan 18, 2025" },
    { id: 2, name: "My folder", date: "Jan 18, 2025" },
    { id: 3, name: "Image", date: "Jan 17, 2025" },
    { id: 4, name: "all documents", date: "Jan 15, 2025" },
    { id: 5, name: "Folder.1", date: "Jan 12, 2025" },
    { id: 6, name: "Folder.1", date: "Jan 11, 2025" },
    { id: 7, name: "Folder.1", date: "Jan 10, 2025" },
  ];
      ...
      >
        {folders.map((folder) => (
          <ItemListRow
            ...
            title={folder.name}
            date={folder.date}
            onPress={() => console.log(`Folder ${folder.name} pressed`)}
            onMenuPress={() => console.log(`Menu for ${folder.name} pressed`)}
          />
        ))}
      </ScrollView>
